...
module Spotify {
    ...
    class onTimerSpotifyCalls {
        ...
        /*
            Request for an access token using the authorization code received from the user
        */
        function firstTokenRequest() as Void {
            ...
            Communications.makeWebRequest(url, params, options, method(:firstTokenResponse));
        }
         /*
        ...
        */
        function checkTokenExpiration() {
            if (tokenExpirationSec == 30) {
                SpotifyAPI.refreshTokenRequest();
            } else {
                tokenExpirationSec -= $.TOKEN_EXP_DT;
            }
        }
        function firstTokenResponse(responseCode as Number, data as Dictionary?) as Void {
            ...
            if (responseCode == 200) {   
                ...
                System.println("Unhandled response in firstTokenResponse(): " + responseCode + " ");
                System.println("Attempting new OAuth...");
                SpotifyAPI.getOAuthToken();
            }
        }
                /*
